...
# ── Custom CSS (inlined — avoids import path issues on Streamlit Cloud) ───────
st.markdown("""
<style>
...
.stTabs [data-baseweb="tab-list"] {
    ...
    padding: 4px; border: 1px solid #e8ecf4;
}
...
.stButton > button[kind="primary"] {
    background: #4f46e5; border: none; border-radius: 8px; font-weight: 600;
}
.insight-card {
    background: #ffffff; border-left: 4px solid #4f46e5;
    border-radius: 8px; padding: 14px 18px; margin: 8px 0;
    box-shadow: 0 1px 4px rgba(0,0,0,0.06); font-size: 0.95rem;
}
.risk-card {
...
.page-title { font-size: 1.8rem; font-weight: 700; color: #1a1f36; margin-bottom: 2px; }
.page-subtitle { font-size: 0.9rem; color: #64748b; margin-bottom: 20px; }
</style>
